...
import { Appointment, AppointmentDateMap, Staff, Treatment } from '../../../shared/types';
...
async function deleteItem<T extends JsonDataType>(
  ...
  try {
    ...
    throw new Error(`Could not delete item id ${itemId} from ${filename}: ${e}`);
  }
}
...
/* ****** Add new appoinment ***** */
async function writeAppointments(newAppointmentsArray: Appointment[]): Promise<void> {
